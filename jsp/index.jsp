...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<!-- 修改的这里 
			<li class="new" class="last"><input type="text" id="selectname" value="${search_words }" /><a href="javascript:selectname()" >&nbsp;&nbsp;搜索</a></li>-->
		</ul>
	</div>
</div>
...
<div id="footer">
	Copyright &copy; 2020 花驿小栈 All Rights Reserved. 鲁ICP备案000001号
</div>
</body>
</html>
